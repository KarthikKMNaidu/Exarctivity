...
import package_circular_float.library.FloatingActionMenu;
import package_circular_float.library.SubActionButton;
...
public class MenuInScrollViewActivity extends AppCompatActivity implements FloatingActionMenu.MenuStateChangeListener, ViewTreeObserver.OnScrollChangedListener, View.OnLayoutChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0; i<20; i++) {
            ...
            rlIcon1.setImageDrawable(getResources().getDrawable(R.mipmap.calendar_color));
            rlIcon2.setImageDrawable(getResources().getDrawable(R.mipmap.qr_color));
            rlIcon3.setImageDrawable(getResources().getDrawable(R.mipmap.holiday_color));
